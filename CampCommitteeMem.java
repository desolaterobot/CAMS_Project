...
public class CampCommitteeMem extends Student {
	private Camp myCamp;
	
	public CampCommitteeMem(String name, String email, String faculty, String passHash, Boolean isCommitteeMember, String committeeMemberOf) {
		super(name, email, faculty, passHash, isCommitteeMember, committeeMemberOf);

...
public class Enquiry{
    ...
    public void reply(User replier, String reply){
        ...
        String enqLine = String.format("%s,%s,%s,%s,%s", enquiryID, student.userID, CSVReader.removeCommas(camp.getCampName()), CSVReader.removeCommas(message), CSVReader.listToString(newIDStrings));
    ...
    public boolean edit(String newMessage){
        ...
        String enqLine = String.format("%s,%s,%s,%s,[]", enquiryID, student.userID, CSVReader.removeCommas(camp.getCampName()), CSVReader.removeCommas(newMessage));
    ...
    public boolean edit(Camp newCamp){
        ...
        this.camp = newCamp;
        String enqLine = String.format("%s,%s,%s,%s,[]", enquiryID, student.userID, CSVReader.removeCommas(camp.getCampName()), CSVReader.removeCommas(message));
        CSVReader.modifyLine("data/enquiry.csv", enquiryID, enqLine);
        return true;
    }
